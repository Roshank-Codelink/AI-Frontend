            ...
            <div className="mb-4 sm:mb-5 md:mb-6">
                <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md">
                    ...
                    <input
                        ...
                        className="w-full pl-10 pr-4 py-2 sm:py-2.5 md:py-3 text-sm sm:text-base border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                    />
                </div>
            </div>
